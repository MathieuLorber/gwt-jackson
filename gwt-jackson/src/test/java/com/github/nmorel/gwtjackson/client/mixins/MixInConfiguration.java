...
public class MixInConfiguration extends AbstractConfiguration {
    ...
    protected void configure() {
        ...
        addMixInAnnotations( BaseClassToMixIn.class, MixinDeserForClassTester.MixIn.class );
        addMixInAnnotations( Object.class, MixinDeserForClassTester.MixIn.class );

        // MixinDeserForCreatorsTester
        addMixInAnnotations( MixinDeserForCreatorsTester.BaseClassWithPrivateCtor.class, MixinDeserForCreatorsTester.MixInForPrivate
                .class );
        addMixInAnnotations( MixinDeserForCreatorsTester.BaseClass.class, MixinDeserForCreatorsTester.MixIn.class );
        addMixInAnnotations( MixinDeserForCreatorsTester.StringWrapper.class, MixinDeserForCreatorsTester.StringWrapperMixIn.class );
        ...
        //        addMixInAnnotations( Object.class, MixinSerForMethodsTester.ObjectMixIn.class );
    }
}
