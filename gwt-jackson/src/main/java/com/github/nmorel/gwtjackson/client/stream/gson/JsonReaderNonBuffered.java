 ...
 * @since 1.6
 */
public class JsonReaderNonBuffered implements com.github.nmorel.gwtjackson.client.stream.JsonReader
{
   ...
   */
  public JsonReaderNonBuffered( String in ) {
    this(in, false);
  }
   ...
   * Creates a new instance that reads a JSON-encoded stream from {@code in}.
   */
  public JsonReaderNonBuffered( String in, boolean lenient ) {
    if (in == null) {
